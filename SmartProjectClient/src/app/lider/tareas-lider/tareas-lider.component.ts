...
@Component({
  selector: 'app-tareas-lider',
  templateUrl: './tareas-lider.component.html',
  styleUrls: ['./tareas-lider.component.scss']
})
export class TareasLiderComponent implements OnInit {
